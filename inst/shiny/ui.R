...
ui <- shinydashboard::dashboardPage(
                         ...
                         shinydashboard::sidebarMenu(
                                             ...
                                             div(class = 'form-group shiny-input-container',
                                                 ...
                                                 div(class = 'input-group', shinyFilesButton("processed_data_path", "Select file...", "Select processed data file", multiple = FALSE))),
                                             div(class = 'form-group shiny-input-container',
                                                 tags$label('New raw data directory'),
                                                 div(class = 'input-group', shinyDirButton("raw_data_directory", "Select directory...", "Select new raw data directory"))),
