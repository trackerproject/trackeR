...
[![Travis-CI Build Status](https://travis-ci.org/trackeRproject/trackeR.svg?branch=master)](https://travis-ci.org/ikosmidis/trackeR)
[![Coverage Status](https://img.shields.io/codecov/c/github/trackeRproject/trackeR/master.svg)](https://codecov.io/github/ikosmidis/trackeR?branch=master)
