...
The route taken during a training session can also be plotted on maps from carious sources
...
*trackeR* can also be used to calculate and visulalise the work capacity W' (pronounced as `W prime`).
