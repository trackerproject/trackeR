...
```{r, plotRoute, message = FALSE, warning = FALSE, fig.width = 6, fig.height = 6}
plotRoute(runs, session = 4, zoom = 13, source = "google")
```

or on an interactive map.

```{r, leafletRoute, fig.width = 7, fig.height = 5}
...
```{r, plot_summary, fig.width = 7, fig.height = 6.3}
...
```{r, timeline, fig.width = 7, fig.height = 6.3}
...
```{r, plot_zones, fig.width = 7, fig.height = 4}
...
```{r, plot_Wprime, fig.width = 7, fig.height = 4}
...
```{r, plot_scores, fig.show = 'hold', fig.width = 7, fig.height = 3.5}
