...
par(mfrow = c(1,2))
plot(runsSummary$durationMoving, cpPCA$scores[,1], xlab = "duration moving", ylab = "PC 1")
plot(runsSummary$avgSpeedMoving, cpPCA$scores[,2], xlab = "average speed moving", ylab = "PC 2")
```
